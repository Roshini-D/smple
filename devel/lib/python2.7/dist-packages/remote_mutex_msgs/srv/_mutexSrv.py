...
"""autogenerated by genpy from remote_mutex_msgs/mutexSrvRequest.msg. Do not edit."""
import codecs
import sys
...
class mutexSrvRequest(genpy.Message):
  ...
  _type = "remote_mutex_msgs/mutexSrvRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.requestor = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.requestor = str[start:end]
      start = end
      end += 1
      (self.requestType,) = _get_struct_B().unpack(str[start:end])
      return self
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from remote_mutex_msgs/mutexSrvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class mutexSrvResponse(genpy.Message):
  ...
  _type = "remote_mutex_msgs/mutexSrvResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class mutexSrv(object):
  _type          = 'remote_mutex_msgs/mutexSrv'
